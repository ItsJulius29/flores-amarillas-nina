...
const LETTER = [
  ...
  'Quiero que en cada día nuestro haya un partido de vóley, una maratón de anime, un mil hojas a medias y una canción de The Weeknd sonando de fondo.',
  ...
  'Feliz Día de las Flores Amarillas. Te quiero muchísimo.',
];

const FAVORITES = [
  { emoji: '💜', title: 'Tus colores', back: 'Morado, lila y negro. Tan tú: misteriosa, dulce y elegante.' },
  { emoji: '❄️', title: 'Tu estación', back: 'El invierno. Prometo abrigarte siempre y compartir mi buzo contigo.' },
  { emoji: '🐾', title: 'Tu animal', back: 'El oso, pero el que más me gusta a mí eres tú.' }, // ← puedes poner el nombre
  ...
  { emoji: '🍫', title: 'Tus antojos', back: 'Chocotejas con guindones y pecanas y todo lo dulce. Te los compro cuando quieras.' },
  ...
  { emoji: '🎬', title: 'Tu película', back: 'Shrek 2. Contigo hasta el "felices para siempre" del ogro.' },
...
const COUPONS = [
  ...
  { emoji: '🏐', title: 'Tarde de vóley', text: 'Voy a verte jugar y a aplaudir cada punto.' },
  { emoji: '🍫', title: 'Antojo dulce', text: 'Chocotejas o Pecas: tú eliges.' },
  { emoji: '🎧', title: 'Playlist compartida', text: 'Una noche de The Weeknd y EXO, con audífono para cada uno.' },
