// ✏️ EDITA AQUÍ: todo el texto de la app vive en este archivo.

export const HER_NAME = 'Mochita'; // ← pon su nombre o apodo
export const MY_NAME = 'Toshito'; // ← firma de la carta
export const TOGETHER_SINCE = '2023-10-20'; // ← ej. '2024-03-14' para mostrar "llevamos X días juntos"
...
export const FAVORITES = [
  ...
  { emoji: '🎤', title: 'EXO', back: 'Con “Heaven” dice: cuando miro al cielo solo pienso en ti.', link: 'https://open.spotify.com/search/EXO%20Heaven' },
